...
/**
 * Provides a framework-agnostic way to test your Http4s app.  You probably want to extend this with
 * either <code>com.github.http4s.test.scalatest.Http4sSuite</code> or
 * <code>com.github.http4s.test.specs.Http4sSpecification</code>.
 *
 ...
 */
trait Http4sTests extends JettyContainer with Client {
  private lazy val log = Logger(getClass)

  implicit def httpTesterToHttp4sHttpTester(t: HttpTester) = new Http4sHttpTester(t)
